...
# 开发环境/预发布环境服务端口存活检测脚本
# 配置：dev.cmft.com/120.196.99.160
...
# ======check ssh======
SERVICE_SSH_IP = '120.196.99.160'
SERVICE_SSH_PORT = 22
SERVICE_SSH_USER = 'root'
SERVICE_SSH_PASSWD = 'dev@oa'
...
# ======check web======
SERVICE_WEB_IP = '120.196.99.160'
SERVICE_WEB_PORT = 80
SERVICE_WEB_APP = 'http://120.196.99.160/static/dUCEN4ry/client/client.zip'
...
## ======check mysql======
#SERVICE_MYSQL_IP = '#SERVICE_MYSQL_IP#'
